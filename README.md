...
[![Build Status](https://travis-ci.org/UMM-CSci-3601-F17/lab-2-client-server-architecture-with-java-spark-lizdex.svg?branch=master)](https://travis-ci.org/UMM-CSci-3601-F17/lab-2-client-server-architecture-with-java-spark-lizdex)
